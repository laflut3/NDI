...
export const POIS = [
  ...
  // Fun Fact POI - 1 of them
  {
    ...
    position: [0, 0.5, -30],
    color: "#a855f7",
    title: "Faits Fascinants",
    icon: "💡",
    content: {
      heading: "Le Saviez-Vous ?",
      facts: [
        "🖥️ L'Obsolescence Forcée : La fin du support de Windows 10 met en évidence un problème majeur? Elle oblige de nombreux établissements scolaires à mettre au rebut du matériel qui fonctionne encore, créant inutilement des déchets électroniques et renforçant la dépendance aux Big Tech.",
        "🌱 Linux, le Système Éco-Responsable : L'une des solutions de la démarche NIRD pour lutter contre l'obsolescence programmée est l'utilisation du système d'exploitation Linux. Étant un logiciel libre, il est souvent moins gourmand en ressources et permet de donner une seconde vie à de vieux ordinateurs.",
